    ...
    <section className="relative overflow-auto pt-[70px] pb-20 sm:pt-[70px] sm:pb-24 lg:pt-[70px] lg:pb-32 w-full">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-14 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
          <div>
            <h1 className="text-3xl tracking-tight font-mono sm:text-4xl lg:text-5xl bg-gradient-to-r from-gray-700 via-gray-500 to-gray-700 bg-clip-text text-transparent animate-fade-in">
              Take Control of Your{" "}
              <span className="text-primary">Business Growth</span>
            </h1>
            <p className="mt-6 text-lg leading-8 sm:text-xl font-mono sm:leading-9 max-w-xl animate-fade-in-delay">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center gap-x-0 gap-y-4 sm:gap-x-6 animate-slide-up">
              <Link
                type="button"
                to={'/login'}
            ...
            <div className="mt-8 flex items-center gap-x-8 text-sm animate-slide-up">
          ...
          <div className="relative lg:ml-10 flex flex-col items-center animate-fade-in-delay">
            <LogoComponent
